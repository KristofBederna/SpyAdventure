...
public class GamePanel extends JPanel implements Runnable{
    ...
    private final MovementHandler MH = new MovementHandler(this);
    private final TileManager TM = new TileManager();
    private final CollisionManager CM = new CollisionManager(this);
    private final ItemManager IM = new ItemManager(this);
    private final Player player = new Player(MH, this, IM);
    private final NPCManager NM = new NPCManager(this);
    private final UI Ui = new UI(this);
    private int timeSpent = 0;
    private boolean finished = false;
    private boolean dead = false;
    private final MinigameManager MM = new MinigameManager(this);
    private String gameState = "go";
    private boolean finishedMinigame = false;
    private final int[] spawnPointsX = new int[10];
    private final int[] spawnPointsY = new int[10];
    private final SoundManager MusicManager = new SoundManager();
    ...
    private void setUpASpawnPoint(int index, int Y, int X) {
    ...
    public TileManager getTM() {return TM;}
